            ...
            {metrics.map((metric, index) => (
                ...
                >
                    <div className="flex items-start justify-between mb-3 sm:mb-4">
                        ...
                        <span
                            className={`text-xs sm:text-sm font-medium ${metric.positive ? "text-green-400" : "text-red-400"
                                }`}
                        >
                            {metric.change}
                        </span>
                    </div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-100 mb-1">{metric.value}</h3>
